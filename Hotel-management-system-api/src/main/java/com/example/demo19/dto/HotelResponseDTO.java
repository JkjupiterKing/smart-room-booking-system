...
public class HotelResponseDTO {
    ...
    public HotelResponseDTO(Long id, String name, String description, double price, double rating, String imageBase64, String imageBase64_2, String imageBase64_3, String imageBase64_4, String imageBase64_5, LocationDTO location, Double longitude, Double latitude) {
        this.id = id;
        this.name = name;
